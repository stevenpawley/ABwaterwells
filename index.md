...
fetches the list of available tables once and returns a connection
object with one named field per table.
...
Data in AWWID is stored in imperial units. Call
[`metricate()`](https://stevenpawley.github.io/ABwaterwells/reference/metricate.md)
to convert a table automatically:
